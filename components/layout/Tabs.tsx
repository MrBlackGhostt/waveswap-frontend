              ...
              >
                ...
                >
                  {heroContent[activeTab].stats.map((stat, index) => (
                    ...
                    >
                      <p className="font-outfit font-bold text-xl" style={{ color: "var(--text-primary)" }}>
                        {stat.value}
                      </p>
                      <p className="text-xs font-rubik" style={{ color: "var(--text-muted)" }}>
                        {stat.label}
                      </p>
                    </motion.div>
                  ))}
  ...
  return (
    ...
    >
      <div className="p-6">
        ...
        {/* FROM Chain */}
        <div className="mb-4">
          <span className="text-xs text-gray-500 font-rubik uppercase mb-2 block">
            From
          </span>
          <button className="w-full flex items-center justify-between p-4 rounded-xl border-2 border-gray-100 hover:border-gray-300 transition-all">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#8B74D0] to-[#6B5AA0] flex items-center justify-center text-white font-bold text-sm">
                E
              </div>
          ...
          {stakingPools.map((pool, index) => (
            ...
            >
              ...
              <div className="text-right">
                <p className="font-outfit font-bold text-[#22C55E]">
                  {pool.apr}
                </p>
